    ...
    return (
        <View style={styles.calculatorContainer}>
            <View style={{ paddingHorizontal: 30, paddingBottom: 20 }}>
                ...
                {
                    (formula === prevNumber ? <Text style={styles.subResult}></Text> : <Text
                        adjustsFontSizeToFit
                        numberOfLines={1}
            ...
            <View style={styles.row}>
                <CalculatorButton onPress={() => clean()} label="C" color={colors.lightGrey} blackText={true} />
                <CalculatorButton onPress={() => toggleSign()} label="+/-" color={colors.lightGrey} blackText={true} />
                <CalculatorButton onPress={() => deleteOperation()} label="del" color={colors.lightGrey} blackText={true} />
            ...
            <View style={styles.row}>
                <CalculatorButton onPress={() => buildNumber('0')} label="0" dobleSize={true} />
